...
extension NSPopUpButton {
    ...
    /// Add an item to the popup button menu with an associated image.
    ///
    /// The image is rescaled to 16x16 to fit in the menu. This is the
    /// conventional size for a 'small' document icon..
    @objc
    ...
    /// Add an item to the popup button menu with the specified tag and
    /// represented object.
    @objc
    ...
    /// Add an item to the popup button menu with the specified represented
    /// object.
    @objc
    ...
    /// Inserts the specified menu item into the popup menu at the given index
    /// and assigns it
